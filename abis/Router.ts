[
	{
		...
		inputs: [
			...
			{ name: "_depositHandler", type: "address", internalType: "address" },
			{ name: "_withdrawHandler", type: "address", internalType: "address" },
			{ name: "_orderHandler", type: "address", internalType: "address" },
			{ name: "_wnt", type: "address", internalType: "address" },
			{ name: "_positionHandler", type: "address", internalType: "address" },
		],
		...
		inputs: [
			{
				...
				components: [
					...
					{ name: "sizeDeltaUsd", type: "uint256", internalType: "uint256" },
					{
					...
					{ name: "executionFee", type: "uint256", internalType: "uint256" },
					{ name: "validFromTime", type: "uint256", internalType: "uint256" },
