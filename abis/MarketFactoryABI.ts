export const MarketFactoryABI = [
	{
		type: "constructor",
		inputs: [{ name: "_dataStore", type: "address", internalType: "address" }],
	...
	},
	{
		...
		inputs: [
			{ name: "longToken", type: "address", internalType: "address" },
			{ name: "shortToken", type: "address", internalType: "address" },
		],
	},
	{
		type: "error",
